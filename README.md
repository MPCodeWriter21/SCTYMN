...
[SCTYMN](https://github.com/MPCodeWriter21/SCTYMN) is a [GitHub](https://github.com/)
repository that includes some simple scripts that can be useful. In other words, the
goal is to save you time when you need a simple script.
...
Feel free to fork this repo and make your changes(You can also send a pull request after
your job's done ;D)
